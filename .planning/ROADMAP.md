...
- [ ] **Phase 10: Parallel Scalar Inference** - Row-parallelize scalar dense + sparse GTIL across all cores via a sound shareable `Model` and honored `Config.nthread`, output identical to the serial path within 1e-5 (plans 2/2 executed; pending orchestrator verification)
...
| 10. Parallel Scalar Inference | 2/2 | Verifying   | - |
